...
var txt2pano_out_items = [
    ...
    // { image: "01.jpg", prompt: "Ancient Incan citadel Machu Picchu, with terraced stone ruins surrounded by lush peaks and misty Andean mountains.", alt: "Ancient Incan citadel Machu Picchu, with terraced stone ruins surrounded by lush peaks and misty Andean mountains." },
    ...
    // { image: "03.jpg", prompt: "Medieval stone castle with towers and courtyards, surrounded by gardens under cloudy skies.", alt: "Medieval stone castle with towers and courtyards, surrounded by gardens under cloudy skies." },
    ...
    { image: "04.jpg", prompt: "A rural landscape with an old stone bridge and a watermill flows into the distance.", alt: "A rural landscape with an old stone bridge and a watermill flows into the distance." },
    ...
    { image: "06.jpg", prompt: "Forbidden City in Beijing, with red palace walls, traditional roofs, stone bridges, and lush green gardens.", alt: "Forbidden City in Beijing, with red palace walls, traditional roofs, stone bridges, and lush green gardens." },
    ...
    { image: "09.jpg", prompt: "Dubai skyline dominated by the Burj Khalifa, surrounded by modern skyscrapers and waterways.", alt: "Dubai skyline dominated by the Burj Khalifa, surrounded by modern skyscrapers and waterways." },
    ...
    { image: "12.jpg", prompt: "Times Square at night, filled with bright billboards, neon lights, and crowds on the streets.", alt: "Times Square at night, filled with bright billboards, neon lights, and crowds on the streets." },
    ...
    // { image: "14.jpg", prompt: "An ancient temple with red pillars rises among cherry blossom trees in full bloom under a clear spring sky."},
    ...
    // { image: "21.jpg", prompt: "Yosemite Valley with towering granite cliffs, forest, and a rocky riverbed.", alt: "Yosemite Valley with towering granite cliffs, forest, and a rocky riverbed." },
